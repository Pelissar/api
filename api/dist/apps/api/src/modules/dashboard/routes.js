...
export async function dashboardRoutes(app) {
    app.get('/dashboard/metrics', { preHandler: requireAdminAuth }, async (request) => {
        ...
        const [totalClients, totalPlans, totalLicenses, activeLicenses, suspendedLicenses, expiredLicenses, expiringIn7Days, totalVersions, updatableLicenses, totalPortalUsers, openTickets, recentClients, recentLicenses, recentVersions, recentTickets] = await Promise.all([
